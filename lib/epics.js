...
const stopHub$ = action$ => action$.pipe(filter(isActionOf(stopSignalRHub)), map(findHub), mergeMap(hub => hub.stop().pipe(map(() => signalrStopped({ hubName: hub.hubName, url: hub.url })), catchError(() => EMPTY))));
