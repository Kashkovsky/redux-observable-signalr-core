import { createSignalRHub, signalrHubUnstarted, signalrHubFailedToStart, signalrConnected, signalrDisconnected, signalrError, reconnectSignalRHub, startSignalRHub, signalrStarted } from "./actions";
...
const beforeStartHub$ = action$ => action$.pipe(filter(isActionOf(signalrHubUnstarted)), mergeMap(action => {
